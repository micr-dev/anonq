  ...
  "[&_svg]:-mx-0.5 relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      size: {
        ...
        variant: {
          default:
            "border-transparent bg-[linear-gradient(135deg,#cdd7ff_0%,#a5b9ff_45%,#7e8cff_100%)] text-slate-950 shadow-[0_18px_45px_-20px_rgba(129,140,248,0.85)] transition-transform duration-150 hover:-translate-y-0.5 hover:shadow-[0_22px_55px_-22px_rgba(129,140,248,0.95)] [:active,[data-pressed]]:translate-y-0 [:active,[data-pressed]]:shadow-[0_14px_40px_-20px_rgba(129,140,248,0.8)]",
          destructive:
          ...
          outline:
            "border-border/80 bg-white/5 text-foreground shadow-[0_10px_40px_-30px_rgba(0,0,0,0.75)] not-disabled:not-active:not-data-pressed:before:shadow-[0_1px_--theme(--color-black/6%)] dark:bg-foreground/5 dark:not-disabled:not-active:not-data-pressed:before:shadow-[0_-1px_--theme(--color-white/6%)] [:disabled,:active,[data-pressed]]:shadow-none hover:bg-white/10 hover:border-border data-pressed:bg-white/12",
          secondary:
            "border-transparent bg-secondary text-secondary-foreground shadow-[0_10px_40px_-28px_rgba(0,0,0,0.55)] hover:bg-secondary/90 data-pressed:bg-secondary/80",
        },
      },
    },
  );
